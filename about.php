...
<html>
	<head>
		<title>About Super Magical Love Party!</title>
	...
	<body>
		<?php
			require 'navbar.php';
		?>
		<h2>About Super Magical Love Party</h2>
		...
		<h3 style="padding-left:20px">Features:</h3>
		<ul style="padding-left:40px">
			...
			<li>
				Powerups:
				<ul>
					<li>Invincible<img src="resources/Sun.png" width="16" height = "16"/> -- Any love given to the player will not give satisfaction to the giver</li>
					<li>Speed<img src="resources/Boot.png" width="16" height = "16"/> -- Move faster</li>
					<li>Special<img src="resources/Cupcake.png" width="16" height = "16"/> -- Abilities are enhanced</li>
					<li>Strength<img src="resources/Potion.png" width="16" height = "16"/> -- Get more satisfaction from giving love</li>
					<li>Apple<img src="resources/Apple.png" width="16" height = "16"/> -- Instantly receive 50% remaining satisfaction</li>
				</ul>
			</li>
			<hr/>
			<li>
			...
			<hr/>
			<li>Has a <a href="index.php">website</a></li>
			<hr/>
		</ul>
		<br/>
		<?php
